...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.shop.rating))]), _vm._v(" "), _c('span', [_vm._v("月售" + _vm._s(_vm.shop.recent_order_num) + "单")])]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
  ...
  }, [_c('span', [_vm._v("¥" + _vm._s(_vm.shop.float_minimum_order_amount) + "起送")]), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.shop.piecewise_agent_fee.tips))])]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.shop.order_lead_time) + "分钟")])])])])])
},staticRenderFns: []}
